        ...
        <table class="min-w-full text-left text-gray-800 text-center text-wrap">
            <thead class="bg-[#E7B548] text-white">
                <tr>
                    ...
                    <th class="px-2 py-2 font-medium text-[clamp(0.45rem,1vw,1rem)]">Nama</th>
                    <th class="px-2 py-2 font-medium text-[clamp(0.45rem,1vw,1rem)]">No Telp</th>
                    <th class="px-2 py-2 font-medium text-[clamp(0.45rem,1vw,1rem)]">Point</th>
                    <th class="px-2 py-2 font-medium text-[clamp(0.45rem,1vw,1rem)]">Masa Berlaku</th>
